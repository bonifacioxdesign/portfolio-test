...
export default function HeroSection() {
    ...
    return (
        <>
            <header>
                <nav data-state={menuState && 'active'} className="fixed top-0  z-50 w-full border-b border-dashed bg-white  backdrop-blur-md dark:bg-zinc-950/50 lg:dark:bg-transparent">
            ...
            <main className="overflow-hidden pt-20">
                    ...
                    <div className="relative pt-24">
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="max-w-3xl text-center sm:mx-auto lg:mr-auto lg:mt-0 lg:w-4/5">
                                <Link href="/" className="rounded-(--radius) mx-auto flex w-fit items-center gap-2 border p-1 pr-3 hover:bg-indigo-600 hover:text-stone-50 ">
                                    <span className="bg-muted rounded-[calc(var(--radius)-0.25rem)] px-2 py-1 text-xs hover:text-stone-500 ">Hey!</span>
                                ...
                                <h1 className="mt-8 text-balance text-4xl font-semibold md:text-5xl xl:text-6xl xl:[line-height:1.125]">Crafting digital interactions</h1>
                                <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block">Discover more about my experience in the creative world. I'm always ready to listen to your ideas and transform them into products that drive your business forward.</p>
                                <p className="mx-auto mt-6 max-w-2xl text-wrap sm:hidden">Discover more about my experience in the creative world. I'm always ready to listen to your ideas and transform them into products that drive your business forward.</p>
                ...
                <section className="bg-background relative z-10 pb-16">
                    <div className="m-auto max-w-5xl px-6">
                        <h2 className="text-center text-lg font-medium">Some companies I have worked for.</h2>
                        <div className="mx-auto mt-12 flex max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 sm:gap-x-16 sm:gap-y-12">
                            <img className="h-5 w-fit dark:invert" src="/colaboralogo.svg" alt="Colabora" height="20" width="auto" />
