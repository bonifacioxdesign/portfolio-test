                    ...
                    <div className="bg-muted/25 group relative mx-auto max-w-[22rem] items-center justify-between space-y-6 [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] sm:max-w-md">
                        ...
                        <div>
                            <InfiniteSlider
                                ...
                                speedOnHover={10}>
                                 <IntegrationCard>
                                    <Image src="/AfterEffects.svg" alt="AfterEffects" width={100} height={100}/>
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/Lighroom.svg" alt="Lighroom" width={100} height={100}/>
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/Illustrator.svg" alt="Illustrator" width={100} height={100}/>
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/Indesign.svg" alt="Indesign" width={100} height={100}/>
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/Premiere.svg" alt="Premiere" width={100} height={100}/>
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/Photoshop.svg" alt="Photoshop" width={100} height={100}/>
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/XD.svg" alt="XD" width={100} height={100}/>
                                </IntegrationCard>
                            </InfiniteSlider>
                        </div>
                        ...
                        <div className="absolute inset-0 m-auto flex size-fit justify-center gap-1">
                            <IntegrationCard
                                ...
                                isCenter={true}>
                                <Image src="/Icon-Boni.svg" alt="XD" width={400} height={400}/>
                            </IntegrationCard>
                        </div>
                    </div>
                    <div className="mx-auto mt-12 max-w-lg space-y-6 text-center">
                        <h2 className="text-balance text-3xl font-semibold md:text-4xl">My prefered tools</h2>
...
const IntegrationCard = ({ children, className, isCenter = false }: { children: React.ReactNode; className?: string; position?: 'left-top' | 'left-middle' | 'left-bottom' | 'right-top' | 'right-middle' | 'right-bottom'; isCenter?: boolean }) => {
    return (
        <div className={cn('bg-background relative z-20 flex size-12 rounded-full border', className)}>
            <div className={cn('m-auto size-fit *:size-', isCenter && '*:size-11')}>{children}</div>
        </div>
    )
}
